...
AppId={{AEA491B8-144B-466E-96D6-4E41848197CC}
AppName={#AppName}
...
OutputBaseFilename=CENOInstaller
; TODO: Replace Freenet graphics with CENO
...
[Languages]
; TODO: Replace "Freenet" with "CENO" in localization.
...
Source: "install_node\plugins\CENO.jar"; DestDir: "{app}"; Flags: ignoreversion
...
// TODO: Detect up-to-date Firefox or Chrome. Modified BrowserUtils to exit depending on availability?
...
var
  sConfigLines : array[0..13] of string;
begin
  if not FileExists(ExpandConstant('{app}\freenet.ini')) then begin
    ...
    // TODO: Use CeNo USK instead of shipping jar.
    sConfigLines[2] := 'pluginmanager.loadplugin=JSTUN;KeyUtils;ThawIndexBrowser;UPnP;Library;CENO.jar';
    sConfigLines[3] := 'node.updater.autoupdate=true';
    sConfigLines[4] := 'node.downloadsDir=.\downloads';
    sConfigLines[5] := 'node.opennet.enabled=true';
    sConfigLines[6] := 'fproxy.hasCompletedWizard=true';
	// TODO: Where do these sizes come from?
    sConfigLines[7] := 'node.storeSize=1073741824';
    sConfigLines[8] := 'node.minDiskFreeLongTerm=1073741824';
    sConfigLines[9] := 'node.slashdotCacheSize=134217728';
    sConfigLines[10] := 'node.clientCacheSize=134217728';
    sConfigLines[11] := 'node.minDiskFreeShortTerm=536870912';
    sConfigLines[12] := 'security-levels.networkThreatLevel=NORMAL';
    sConfigLines[13] := 'End';
